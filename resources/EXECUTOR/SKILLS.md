...
3. For every test case use tool `test_endpoint`. Replace request parameter placeholders if necessary. Capture response status code, headers, body, elapsed time, and any errors
